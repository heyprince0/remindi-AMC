...
import { Search, Download, CheckCircle2, XCircle, Clock, Loader2 } from "lucide-react"
...
export default function ServiceHistoryPage() {
  ...
  // =============================================
  // PDF GENERATION – jsPDF (no window.print)
  // =============================================
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      doc.text("Service History Report", pageW / 2, y, { align: "center" })
      ...
      if (profile?.company_name) {
        ...
        doc.setFontSize(9)
        doc.text(profile.company_name, pageW / 2, y, { align: "center" })
      }
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-2">
            {/* Export Modal button (for Excel/CSV) */}
            <Button
              variant="outline"
        ...
        {/* Export Modal – for Excel/CSV downloads */}
        <ExportModal
